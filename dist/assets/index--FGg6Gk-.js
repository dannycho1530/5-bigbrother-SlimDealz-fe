import{d as n,j as e,c as y,e as w,b as g,i as m,g as C,A as I,M as S}from"./mui-BKwklMrZ.js";import{r as i}from"./react-mdsbzbFi.js";import{a as p}from"./vendor-DsPaXkF5.js";import{g as M,d as P,c as $,r as j,u as T,e as z,L as _,f as B}from"./index-BHZqvDrh.js";const D=n.div`
  display: flex;
...
`,ne=n.div`
  ...
  height: 30px;
  border-radius: 8px;
`,re=({open:o,onClose:t,onLogin:r})=>e.jsx(S,{open:o,onClose:t,children:e.jsx(se,{children:e.jsxs(ae,{children:[e.jsx(ie,{children:"로그인이 필요합니다"}),e.jsx("hr",{style:{width:"50px",margin:"10px auto",borderColor:"white"}}),e.jsx(ce,{children:"북마크는 로그인이 필요한 서비스입니다. 로그인하시겠습니까?"}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between"},children:[e.jsx(h,{onClick:t,children:"취소"}),e.jsx(h,{onClick:r,children:"로그인하러가기"})]})]})})}),se=n.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
